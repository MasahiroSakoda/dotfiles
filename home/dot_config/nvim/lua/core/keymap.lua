...
wk.add({
  ...
  { "g[",         "<CMD>lua vim.diagnostic.jump({count=-1,float=true})<CR>", icon = "󰒮 ", desc = " Prev Diagnostic" },
  { "g]",         "<CMD>lua vim.diagnostic.jump({count=1,float=true})<CR>",  icon = "󰒮 ", desc = " Next Diagnostic" },
