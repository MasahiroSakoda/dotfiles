...
| Command                             | Description                        |
| :---------------------------------- | :--------------------------------- |
| `chezmoi chattr +template [target]` | Add template attribute to file     |
| `chezmoi chattr -template [target]` | Remove template attribute to file  |
